data atussum_2021;
length TUCASEID $14;
infile 'c:\atussum_2021.dat' lrecl=8192 dlm=',' missover dsd firstobs=2;
input
TUCASEID
TUFINLWGT
TRYHHCHILD
...
label t160299 = "Waiting associated with telephone calls, n.e.c.*";
...
;
run;
proc contents data=atussum_2021; run;
